...
from odoo.addons.devhub_infrastructure.models import dev_machine_verification as verify_mod
from odoo.addons.devhub_infrastructure.tests.common import (
...
class TestVerifyTailscaleDestination(TransactionCase):
            ...
            .create(
                {
                    ...
                    "group_ids": [
                        (
                            6,
                            0,
                            [cls.env.ref("devhub_core.group_dev_hub_user").id],
                        )
                    ],
                }
            )
    ...
    def test_temp_known_hosts_mode_0600(self):
        ...
        from odoo.addons.devhub_infrastructure.models.dev_machine_verification import (
    ...
    def test_temp_known_hosts_cleanup_on_ssh_failure(self):
        ...
        with patch.object(
            ...
            "odoo.addons.devhub_infrastructure.models.dev_machine_verification.tempfile.mkdtemp",
