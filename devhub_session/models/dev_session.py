...
class DevSession(models.Model):
    ...
    def _run_git(path, *args):
        # Worker-owned worktrees are read by the Odoo service user for snapshots.
        # Match execution/_git: pass safe.directory so Git does not reject dubious ownership.
