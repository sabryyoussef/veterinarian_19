"""Ashby-like offline fixture adapter (draft fill only)."""
...
class AshbyLikeAdapter(BaseApplyAdapter):
    name = "ashby_like"

    async def can_handle(self, page) -> bool:
        marker = page.locator("[data-adapter='ashby_like'], #ashby-like-form")
    ...
    async def fill_draft(self, page, applicant: ApplicantFixture, cv_path: str) -> AdapterResult:
        ...
        mapping = [
            ...
            ("textarea[name='additionalInfo'], #additionalInfo", applicant.cover_letter, "additionalInfo"),
        ]
        ...
        return AdapterResult(
            ...
            message="ashby_like draft filled (dry-run; submit not clicked)",
