...
See also: [`SYNTHETIC_POLICY.md`](SYNTHETIC_POLICY.md), [`CANARY_READINESS_CHECKLIST.md`](CANARY_READINESS_CHECKLIST.md),
[`MANUAL_TESTING.md`](MANUAL_TESTING.md) for operator UAT checklists,
and [`PHASE15A_SHADOW.md`](PHASE15A_SHADOW.md) for the shadow landed-cost engine.
